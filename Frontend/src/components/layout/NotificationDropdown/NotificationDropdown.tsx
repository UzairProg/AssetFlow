  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 transition hover:bg-slate-100 hover:text-blue-900"
      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className="absolute right-0 top-14 z-20 w-96 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl shadow-slate-200/70"
          >
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm font-semibold text-blue-900 transition hover:text-blue-700">
                View All
              </a>
            </div>
              ...
              {notifications.map((item) => {
                ...
                return (
                  <div key={item.title} className="flex gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-blue-900 text-white">
